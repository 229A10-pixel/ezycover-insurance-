...
const SURVEY_DEFINITIONS = {
  zh: [
    ...
    createLikert('social1', '我觉得这个旅行目的地的社会文化与我所在的环境差异很大。', 'I feel that the social and cultural environment of this destination is very different from the one I live in.'),
    createLikert('social2', '我对这个目的地的社会环境、生活方式不太熟悉。', 'I am not very familiar with the social environment and lifestyle of this destination.'),
    createLikert('social3', '我感觉这个地方的社会氛围与我的生活圈距离较远。', 'I feel that the social atmosphere of this place is relatively distant from my own social circle.'),
  ...
  en: [
    ...
    createLikert('social1', 'I feel that the social and cultural environment of this destination is very different from the one I live in.', 'I feel that the social and cultural environment of this destination is very different from the one I live in.'),
    createLikert('social2', 'I am not very familiar with the social environment and lifestyle of this destination.', 'I am not very familiar with the social environment and lifestyle of this destination.'),
    createLikert('social3', 'I feel that the social atmosphere of this place is relatively distant from my own social circle.', 'I feel that the social atmosphere of this place is relatively distant from my own social circle.'),
