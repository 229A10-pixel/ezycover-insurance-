...
const EXPERIMENT_VARIABLES = {
  // 响应时间（毫秒）
  responseTime: 1000, // 1000 = 1秒，后续可改为 2000 或 3000
...
const FLIGHT_DATES = {
  zh: [
    { value: '3days', label: '3 天后' },
    { value: '1week', label: '1 周后' },
    { value: '2weeks', label: '2 周后' },
    { value: '1month', label: '1 个月后' }
  ],
  en: [
